...
export const TRANSLATIONS: { en: TranslationDictionary; ar: TranslationDictionary } = {
  en: {
    ...
    contact: {
      ...
      emailResponseTime: "Responses during office hours",
      ...
      formSubtitle: "Share your requirements for consultant review and a tailored quotation.",
    ...
    estimator: {
      ...
      bankLabel: "Corporate bank application guidance",
  ...
  ar: {
    ...
    contact: {
      ...
      formSubtitle: "أرسل متطلباتك لمراجعتها وإعداد عرض سعر مناسب.",
