...
export const COMPANY_INFO = {
  ...
  stats: {
    experienceYears: "12+",
    freeZonesServed: "4 Free Zones",
    freeZonesServedAr: "4 مناطق حرة",
...
export const CORPORATE_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    fullDescAr: 'دعم عقاري متخصص للتنسيق بين الملاك وإدارات العقارات والجهات المرخصة للتحقق من مطابقة العقار للمخططات البلدية، وشروط الدفاع المدني، والمساحة القانونية للنشاط.',
  ...
  },
  {
    ...
    shortDesc: 'Dedicated outsourced PRO retainers for established firms, with tracked renewal dates and compliance reminders.',
    shortDescAr: 'عقود إدارة علاقات عامة شاملة للشركات مع متابعة مواعيد التجديد وتنبيهات الامتثال.',
...
export const DIGITAL_ENGINE_SERVICES = [
  {
    ...
    tagline: 'Responsive web applications built for clear customer journeys, crawlable content and measurable enquiry flows.',
    taglineAr: 'تطبيقات ويب متجاوبة مبنية لمسارات عملاء واضحة، ومحتوى قابل للفهرسة، وتدفق استفسارات قابل للقياس.',
    features: [
      'Next.js & React Server Components',
      'Performance budget agreed and measured for each project',
      'Full Bilingual Arabic-English RTL typography',
      'Integrated live cost estimators & CRM pipelines'
    ],
    featuresAr: [
      'تقنيات Next.js ومكونات الخادم',
      'ميزانية أداء متفق عليها وتُقاس لكل مشروع',
  ...
  },
  {
    ...
    tagline: 'Dark interfaces, micro-animations and glass surfaces, built as a consistent and considered design system.',
    taglineAr: 'واجهات داكنة، وحركات دقيقة، وأسطح زجاجية، ضمن نظام تصميم متسق ومدروس.',
    features: [
  ...
  },
  {
    ...
    tagline: 'Refined visual identity, typography systems and executive pitch collateral prepared for government and institutional audiences.',
    taglineAr: 'هوية بصرية راقية، وأنظمة خطوط متناسقة، وعروض تقديمية تنفيذية مُعدّة لمخاطبة الجهات الحكومية والمؤسسات.',
    features: [
...
export const CHANNEL_PARTNERS: ChannelPartnerItem[] = [
  ...
  },
  {
    ...
    badge: 'Cost-Efficient Dubai Option',
    badgeAr: 'خيار اقتصادي في دبي',
  ...
  },
  {
    ...
    city: 'Ajman',
    cityAr: 'عجمان',
    badge: 'Budget-Focused Jurisdiction',
    badgeAr: 'وجهة مناسبة للميزانيات المحدودة',
...
export const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    category: 'Digital & Web',
    categoryAr: 'الحلول الرقمية والويب',
    question: 'Which platform do you build client websites on, and how does that compare with WordPress or Wix?',
    questionAr: 'ما المنصة التي تبنون عليها مواقع العملاء، وكيف تقارن بووردبريس أو ويكس؟',
