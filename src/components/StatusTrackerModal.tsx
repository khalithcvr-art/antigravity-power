            ...
            <div className="space-y-6 animate-in fade-in duration-300">
              ...
              <div className="p-6 rounded-2xl bg-obsidian-950 border border-white/10 relative overflow-hidden">
                ...
                <div>
                  ...
                  <div className="w-full h-2.5 rounded-full bg-obsidian-900 overflow-hidden p-0.5 border border-white/5">
                    <div 
                      className="h-full rounded-full bg-gradient-to-r from-emerald-500 to-cyan-400 transition-all duration-700 shadow-sm shadow-emerald-400"
                      style={{ width: `${activeApplication.currentProgressPercent}%` }}
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {activeApplication.milestones.map((milestone) => (
                    <div
